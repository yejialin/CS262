...
<ul>
  ...
  (SMALL)</small>,<big>big(BIG)</big>,or look like a <tt>typewriter(TT) </tt>.</li>
  <li> There are also ordered lists that use (OL) tags. Let's make one
  nested inside our current list item.
    <ol>
    <li> Text can also be <strong>strong(STRONG)</strong> or
    <em>emphasized(EM)</em>, which typically renders like bold and
    italics.</li>
    <li> Webpages can have <a href="http://www.google.com">hyperlinks
    (A HREF="target")</a>. </li>
    </ol>
  </li>
  <li> It is also possible to include images <img src="cs262.png"> </img>
  (IMG SRC="cs262.png")
  </li>
</ul>
</p>
